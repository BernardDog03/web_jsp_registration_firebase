<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body class="">
              ...
              <div class="card-body">
               ...
               <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Greeting Table</h6>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                        <table id="tb_greet" class="table table-bordered" width="100%" cellspacing="0">
                            <tr>
                              <td>#ID</td>
                              <td>Major</td>
                              <td>First name</td>
      ...
      <script>
        var tbchild = document.getElementById('tb_greet');
        ...
        databaseRef.once('value', function(snapshot) {
         ...
         var table = document.getElementById("tb_greet");
         ...
         for (i = 0; i < rows.length; i++) {
             ...
             firebase.database().ref().child('/greeting/' + uid).remove();
