<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body class="">
               ...
               <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                        <table id="tb_conv" class="table table-bordered" width="100%" cellspacing="0">
                            <tr>
                              <td>#ID</td>
                              <td>Major</td>
                              <td>First name</td>
      ...
      <script>
        var tbchild = document.getElementById('tb_conv');
        ...
        databaseRef.once('value', function(snapshot) {
         ...
         var table = document.getElementById("tb_conv");
