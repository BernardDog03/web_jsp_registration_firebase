                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            <h2>About Us</h2>
                            <p>Our website provides an online French course. 
                                And we also provide various ways to help you learn and master French properly.</p>
                            <div class="page_link">
            ...
            <div class="row align-items-center">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="dpmt_right">
						...
						</br>With various levels ranging from the </br> easiest to the most difficult. We will help you in a fun and easy way.</p>
