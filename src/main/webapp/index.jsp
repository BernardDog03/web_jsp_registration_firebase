...
<head>
	...
	<title>Frenchopedia | French Course</title>
	<!-- Bootstrap CSS -->
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="banner_content">
							...
							<p>
								Learning French is easy with us. Try our courses by language experts! The shortest path to real-life conversation. Start today! Simple, Effective, Fun.
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4">
					<div class="single_feature d-flex flex-row pb-30">
						...
						<div class="desc">
							<h4>Classes</h4>
							<p>
								Provides any grades for french language.
							</p>
						</div>
					</div>
					<div class="single_feature d-flex flex-row pb-30">
					...
					<div class="single_feature d-flex flex-row">
						...
						<div class="desc">
							<h4>Full E-Books</h4>
							<p>
								Provides so many E-Books for learning.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_fact">
						...
						<p>We provide mentors who are reliable in helping you to learn French.</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-4 col-md-6">
					<div class="single_fact">
						...
						<h4>25000+ Courses</h4>
						<p>25000+ courses to help you learn French properly and correctly <br> 
							in a way that is also true and correct. </br>
							Offers a variety of French courses </br> which will certainly help you to prove your language skills.
						</br>With various levels ranging from the </br> easiest to the most difficult. We will help you in a fun and easy way.
						</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-4 col-md-6">
					<div class="single_fact">
						...
						<p>Register as a student membership will get a variety of promos for learning French.</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-4 col-md-6">
					<div class="single_fact">
						...
						<p>Lifetime access means that for a single payment, the customer gets unlimited access to the product, and sometimes, free updates or other benefits as the product or technology evolves.</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-4 col-md-6">
					<div class="single_fact">
						...
						<p>Source file inclusion. Includes other source file into current source file at the line immediately after the directive.</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-4 col-md-6">
					<div class="single_fact">
						...
						<h4>Live Support</h4>
						<p>we also provide Live Support where you can hear the pronunciation properly and correctly to learn.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-4 offset-lg-1">
					<div class="register_form">
						...
						<form class="form_area" id="myForm" action="mail.jsp" method="post">
							<div class="row">
